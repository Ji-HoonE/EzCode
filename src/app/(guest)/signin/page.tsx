    ...
    <Suspense fallback={<></>}>
      <div className="flex justify-center gap-[32px] items-center">
        <div className="flex flex-col justify-center mb-[60px]">
          <p className="text-[32px] font-[500] text-white text-end leading-[47px]">
            어서오세요, <br />
            당신의 코딩을 돕는
          </p>
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="w-full flex justify-center items-center gap-[32px] mt-[9px]">
            ...
            <p className="text-[13px] font-[400] text-[#FFFFFF] leading-[33px]">
              개인정보 처리방침
            </p>
            <p className="text-[13px] font-[400] text-[#FFFFFF] leading-[33px] underline underline-offset-[2px]">
              FAQ/문의
            </p>
          </div>
        </div>
